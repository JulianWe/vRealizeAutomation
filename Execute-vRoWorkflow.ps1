##########################################################################################################
##################### REST CALL to Execute vRo Workflow and pass input Parameters ########################
##########################################################################################################
# Julian Wendland 07.12.2020 for Sunrise Communications
# Parameters:
Param(
    ...
    [string]$inputFile = 'C:\Users\JW\Desktop\vRO-API\body.json'# path to input file (either json or xml)
)
